    ...
    protected void onCreate(Bundle savedInstanceState)
        {
            ...
            filter.addAction(MESSAGE_DETAILS_AVAILABLE);
            ...
            // Set up the drawer.
            navigationDrawerFragment.setUp(toolbar, R.id.navigation_drawer,
        ...
        public void onReceive(Context context, Intent intent)
            {
                if (intent.getStringExtra(MESSAGE_KEY) != null)
                    ...
                    } else if (intent.getAction() == MESSAGE_DETAILS_AVAILABLE)
                    {
